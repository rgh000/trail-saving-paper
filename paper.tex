...
\centering
    \begin{tabular}{|l|l|l|l|l|l|}
      ...
      maple-trail-multipleBT-lookahead & \textbf{473} & \textbf{277} &  195  & \textbf{4584} \\ \hline
      maple-trail-multipleBT-lookahead-reason & 999 & 999 & 999 & 9999 \\ \hline
    \end{tabular}
...
\section{Conclusion}
We have shown that our method "trail savings" can speed up two
...
of CDCL \sat solvers. We also introduced three enhancements one can
implement if they are using a saved trail and demonstrated experimentally
that these enhancements can sometimes improve the performance by a significant
amount. Future work could include tuning the parameters of the enhancements 
to work optimally or introducing further enhancements, such as using the saved
trail to help make inprocessing techniques faster or
using the saved trail to learn a second learnt clause from a single conflict.
Lastly, it might be possible to combine trail saving with chronological
backtracking and figure out when each is most beneficial.
