...
each instance with and without trail saving enabled in cadical. With
trail saving enabled about 1.87 million propagations per second occur,
and without trail saving about 1.80 million propagations per second
occur. The graph further illustrates that the majority of the time
cadical with trail saving enabled will propagate literals faster than
...
using the saved trail to learn a multiple clauses from a single
