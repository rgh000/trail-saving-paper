...
sometimes beneficial for the solver backtrack fully and redo its
trail, even if this takes more work. We will expand on why this might
be case below.

In this paper we present an alternative ``trail savings'' method where
by we save the backtracked part of the solver's trail and attempt to
...
as we will be sometimes be working with trails that would never be
